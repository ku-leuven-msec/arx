...
public class HierarchyWizardPageType<T> extends WizardPage {
    ...
    /** Var. */
    private final HierarchyWizardPageExternal<T> scriptPage;
    ...
    public HierarchyWizardPageType(final HierarchyWizard<T> wizard,
                                   ...
                                   final HierarchyWizardPageExternal<T> scriptPage) {
    ...
    public void createControl(final Composite parent) {
        ...
        this.script = new Button(composite, SWT.RADIO);
        this.script.setText(Resources.getMessage("HierarchyWizardPageType.7")); //$NON-NLS-1$
        ...
        this.script.addSelectionListener(new SelectionAdapter(){
            @Override public void widgetSelected(SelectionEvent arg0) {
                if (script.getSelection()) {
                    next = scriptPage;
                    model.setType(Type.EXTERNAL_BASED);
                }
            }
        });
        ...
        script.setSelection(model.getType() == Type.EXTERNAL_BASED);
        ...
        case EXTERNAL_BASED:  next = scriptPage;    break;
        default:
